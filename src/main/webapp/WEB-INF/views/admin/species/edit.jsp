...
<body>
	<div id="container">
		...
		<form method= "post" action="${pageContext.request.contextPath }/admin/species/update">
			<div class="form-container">
				<div class="form-input">
					<label for="name">Species name:</label>
					<input type="text" id="name" name="name" class="JS-fade" value="${species.name}" placeholder="Name">
				</div>
				<div class="btn-container">
					<a class="btn-back" href="${pageContext.request.contextPath }/admin/species">cancel</a>
					<button class="btn-submit" name="id" value="${species.id}" type="submit">Submit</button>
				</div>
			</div>
		</form>
		</div>
